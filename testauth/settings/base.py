...
INSTALLED_APPS = [
    "allianceauth",  # needs to be on top of this list to support favicons in Django admin
...
LANGUAGE_MAPPING = {
    # See the DataTables i18n list for available languages
    ...
    # See the moment locale list for available languages
